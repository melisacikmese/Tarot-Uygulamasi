...
for i in range(3):
    ...
    kart_anlam_uc = tk.Label(dikey_kart_cercevesi, text="", font=("Arial", 10), bg="#F5E9E2", fg="#7F7A78" , wraplength=KART_GENISLIK - 50, justify=tk.CENTER)
...
def tek_kart_cek():
    ...
    resmi_yukle(secilen, tek_kart_etiketleri['resim'], (KART_GENISLIK, KART_YUKSEKLIK))
...
def uc_kart_cek():
    ...
    for i in range(3):
        ...
        resmi_yukle(kart_adi, etiketler['gorsel'], (KART_GENISLIK - 50, KART_YUKSEKLIK - 50)) 
